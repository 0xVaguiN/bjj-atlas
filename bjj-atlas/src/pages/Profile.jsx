...
export default function Profile() {
  ...
  return (
    <>
      <div className="relative px-10 py-2 h-full font-display">
        ...
        <div className="max-w-8xl flex justify-center">
          <div className="flex mt-10 flex-wrap gap-8 justify-center">
            <div className="border-2 py-4 px-5 border-[#C6C6C6] rounded-2xl w-[270px] h-40 bg-red-50">
                <h1 className="text-gray-500 text-base">Técnicas Aprendidas</h1>
            ...
            <div className="border-2 py-4 px-5 border-[#C6C6C6] rounded-2xl w-[270px] h-40 bg-red-50">
                <h1 className="text-gray-500 text-base">Em progresso</h1>
                <h1 className="font-bold text-4xl">{learned.length}</h1>
            ...
            <div className="border-2 py-4 px-5 border-[#C6C6C6] rounded-2xl w-[270px] h-40 bg-red-50">
                <h1 className="text-gray-500 text-base">Favoritas</h1>
                <h1 className="font-bold text-4xl">{learned.length}</h1>
            ...
            <div className="border-2 py-4 px-5 border-[#C6C6C6] rounded-2xl w-[270px] h-40 bg-red-50">
                <h1 className="text-gray-500 text-base">Conquistas Desbloqueadas</h1>
                <h1 className="font-bold text-4xl">{learned.length}</h1>
